...
namespace UCV.Services
{
    ...
    public class CompaniasService : ICompaniasService
    {
        ...
        public List<Compania> GetCompaniasById(string id)
        {
            throw new NotImplementedException();
        }

        public List<Compania> GetCompaniasByIdCal(string id, string ruc, int calificacion)
        {
            throw new NotImplementedException();
        }

        public List<Compania> GetCompaniasByIdRuc(string id, string ruc)
        {
            throw new NotImplementedException();
        }
